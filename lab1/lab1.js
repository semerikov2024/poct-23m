...
document.addEventListener("DOMContentLoaded", () => {
	const start = async() => {
		const mindarThree = new MindARThree({
			...
			imageTargetSrc: "assets/business_card.mind",
		});
		...
		const [cardTexture, emailTexture, locationTexture, webTexture, profileTexture,
			leftTexture, rightTexture, portfolioItem0Texture, portfolioItem1Texture,
			portfolioItem2Texture, ] = await loadTextures([
			"assets/business_card.jpg",
			"https://live.staticflickr.com/1316/1301796545_7aee4aef61.jpg",
			"https://live.staticflickr.com/65535/48078008041_21e1cc1a02_b.jpg",
			"assets/62207cf7944f5cd67921e29e.png",
			...
			"assets/photo.png", // https://semerikov2024.github.io/poct-23m/
			"assets/pageHeaderLogoImage_en_US.png", // https://acnsci.org/cte
		]);

		const planeGeometry=new THREE.PlaneGeometry(1, 1343/2493.0);
		...
		const avatar = await loadGLTF("https://raw.githubusercontent.com/AR-js-org/"+
